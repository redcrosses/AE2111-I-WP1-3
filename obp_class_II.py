...
class class_II_weight:
  def __init__(self, W_dg, Nz, S_w, t_c_root, A, lam, L_t, cos_Lambda, S_csw, K_uh, F_w_Bh, S_ht, cos_Lambda_ht, A_ht, S_e, H_h, S_vt, K_2, cos_Lambda_vt, A_v, K_door, K_Lg, S_f, K_ws, L_D, K_mp, W_l, Nl, L_m, N_mw, N_mss, V_stall, K_np, N_nw, K_ng, N_Lt, W_ec, S_n, N_en,W_en, V_i,L_n, N_w, K_y,L) -> None:
    ...
    self.total = self.wing + self.htail +self.vtail + self.fus + self.main_lg + self.nose_lg + self.nacelle + self.starter + self.fuel_sys
